...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PassphraseHash.passphrase'
        db.alter_column(u'unclear_passphrasehash', 'passphrase', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PassphraseHash.passphrase'
        db.alter_column(u'unclear_passphrasehash', 'passphrase', self.gf('django.db.models.fields.CharField')(max_length=64))
